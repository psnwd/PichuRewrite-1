module.exports = {
    name: 'prefix',
    usage: 'pichu prefix <new prefix>',
    description: 'Changes pichu\'s prefix on this server',
    category: 'utility',
    execute(client,message,args) {
        if (message.author.id === client.ownerID || !message.member.permissions.toArray().includes("ADMINISTRATOR")) return message.channel.send('Only servers admins can change my prefix');
