module.exports = {
  ...
  aliases: ['ui'],
	...
	async execute(client,message,args) {
        ...
        let user = message.mentions.users.first() || client.users.cache.get(args.join(' ')) || client.users.cache.find(user => user.username.toLowerCase() === args.join(' ').toLowerCase())|| message.author;
        let isabot = ''
